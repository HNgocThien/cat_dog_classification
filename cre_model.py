...
# Định nghĩa đường dẫn lưu file model.py
output_folder = r"D:\THIEN_PROJECT\cat-dog_classification\model"
os.makedirs(output_folder, exist_ok=True)  # Tạo thư mục nếu chưa tồn tại

model_file_path = os.path.join(output_folder, "model.py")

# Ghi nội dung vào file model.py với encoding rõ ràng
with open(model_file_path, "w", encoding="utf-8") as f:
    f.write(model_code)

print(f"✅ File model.py đã được tạo tại: {model_file_path}")
